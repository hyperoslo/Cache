...
final class StorageSupportTests: XCTestCase {
  ...
  func testSetPrimitive() throws {
    do {
      let s = storage.support(transformer: TransformerFactory.forCodable(ofType: Bool.self))
    ...
    do {
      let s = storage.support(transformer: TransformerFactory.forCodable(ofType: Int.self))
    ...
    do {
      let s = storage.support(transformer: TransformerFactory.forCodable(ofType: Double.self))
  ...
  func testSetData() {
    let s = storage.support(transformer: TransformerFactory.forData())
  ...
  func testSetDate() throws {
    let s = storage.support(transformer: TransformerFactory.forCodable(ofType: Date.self))
  ...
  func testSetURL() throws {
    let s = storage.support(transformer: TransformerFactory.forCodable(ofType: URL.self))
  ...
  func testWithSet() throws {
    let s = storage.support(transformer: TransformerFactory.forCodable(ofType: Set<Int>.self))
